...
namespace Ivoryservices.Controllers
{
    public class SubreportController : Controller
    {
        ...
        public SubreportController(Microsoft.AspNetCore.Hosting.IHostingEnvironment _environment, ILogger<HomeController> logger, OnestopContext context)
        {
        ...
        protected PdfPTable Add_Content_To_PDF(PdfPTable tableLayout)
        {
            ...
            float[] headers = { 30, 30, 30  };  //Header Widths
            ...
            var Invoices_items = _context.SubCategories.ToList();
            ...
            AddCellToHeader(tableLayout, "SubCategory Image");
            ////Add body
            ...
            foreach (var bkm in Invoices_items)
            {
                ...
                AddCellToBody(tableLayout, bkm.Sub_Image.ToString());
